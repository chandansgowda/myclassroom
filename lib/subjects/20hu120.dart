...
class Innovation extends StatefulWidget {
  ...
  // Innovation(this.title, this.db_name)
...
class _InnovationState extends State<Innovation> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("Innovation");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Innovation Studies'),
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/innovation/").child(name);
