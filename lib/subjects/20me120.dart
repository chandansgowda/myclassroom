...
class Graphics extends StatefulWidget {
  ...
  // Graphics(this.title, this.db_name)
...
class _GraphicsState extends State<Graphics> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("Graphics");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('EGD - 20ME120'),
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref('onlinepdf/graphics/').child(name);
