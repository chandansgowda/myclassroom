...
class Chemistry extends StatefulWidget {
  ...
  // Chemistry(this.title, this.db_name)
...
class _ChemistryState extends State<Chemistry> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("Chemistry");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Chemistry - 20CH110'),
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/chemistry/").child(name);
