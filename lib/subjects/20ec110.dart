...
class Electronics extends StatefulWidget {
  ...
  // Electronics(this.title, this.db_name)
...
class _ElectronicsState extends State<Electronics> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("Electronics");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Electronics - 20EC110'),
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/electronics/").child(name);
