...
class Mathematics extends StatefulWidget {
  ...
  // Mathematics(this.title, this.db_name)
...
class _MathematicsState extends State<Mathematics> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("Mathematics");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Mathematics - 20MA110'),
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/mathematics/").child(name);
