...
class ChemistryLab extends StatefulWidget {
  ...
  @override
  _ChemistryLabState createState() => _ChemistryLabState();
}

class _ChemistryLabState extends State<ChemistryLab> {
  List<Modal> itemList=List();
  final mainReference = FirebaseDatabase.instance.reference().child("CheLab");
  @override
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/chelab/").child(name);
