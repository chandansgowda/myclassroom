...
class English extends StatefulWidget {
  ...
  // English(this.title, this.db_name)
...
class _EnglishState extends State<English> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("English");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('English - 20HU130'),
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/english").child(name);
