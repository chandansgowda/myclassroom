...
class _SyllabusState extends State<Syllabus> {
  ...
  final mainReference = FirebaseDatabase.instance.reference().child("Syllabus");
  @override
  ...
  savePdf(List<int> asset, String name) async {
    Reference reference = FirebaseStorage.instance.ref("onlinepdf/syllabus/").child(name);
